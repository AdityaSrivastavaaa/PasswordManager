            ...
            <tbody className="bg bg-purple-200">
              {passwordArray.map((item , index)=>{
                ...
                <td className="  py-2 border border-white text-center ">
                  ...
                  {item.username} <div className="size-7 cursor-pointer" onClick={()=>{copyText(item.username)}}>
                <img src={copy} alt="" />
                </div>
                </div></td >
                <td className="  py-2 border border-white text-center ">
                  ...
                  {item.password} <div className="size-7 cursor-pointer" onClick={()=>{copyText(item.password)}}>
                <img src={copy} alt="" />
                </div>
                </div></td>
